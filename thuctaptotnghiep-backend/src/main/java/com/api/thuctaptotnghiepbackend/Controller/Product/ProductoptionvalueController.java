...
public class ProductoptionvalueController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Productoptionvalue> getProductById(@PathVariable("id") String ProductId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/Products/1
    public ResponseEntity<Productoptionvalue> updateProduct(@PathVariable("id") String ProductId,
