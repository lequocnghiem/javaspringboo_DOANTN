...
public class ProductstoreController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Productstore> getProductStoreById(@PathVariable("id") String productstoreId) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Productstore> updateProductStore(@PathVariable("id") String productstoreId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductStore(@PathVariable("id") String productstoreId) {
