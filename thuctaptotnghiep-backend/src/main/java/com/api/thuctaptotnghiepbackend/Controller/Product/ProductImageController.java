...
@GetMapping("{id}")
    public ResponseEntity<Productimage> getProductById(@PathVariable("id") String ProductId) {
 ...
 @GetMapping
    ...
    public ResponseEntity<Productimage> updateProduct(@PathVariable("id") String ProductId,
