...
public class ProductoptionController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Productoption> getProductById(@PathVariable("id") Long ProductId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/Products/1
    public ResponseEntity<Productoption> updateProduct(@PathVariable("id") Long ProductId,
